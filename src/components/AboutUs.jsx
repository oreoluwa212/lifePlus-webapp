...
const AboutUs = () => {
  return (
    <>
      ...
      <div className="flex flex-col-reverse mds:flex-row  w-full lgss:h-[90vh]">
        <div className="lgss:w-[45%] w-full lgss:h-[500px] h-[400px] text-red flex flex-col justify-center items-center font-bold">
          <h1 className="text-[20px] lgss:w-[70%] w-[90%] text-center lgss:leading-10">
          ...
          <h1 className="text-[20px] lgss:w-[70%] w-[90%]   lgss:leading-10 text-center pt-4">
