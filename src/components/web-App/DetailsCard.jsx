...
const DetailsCard = () => {
  return (
    <div className="lgss:w-[80%] bg-opacity-90 bg-[#dda195] bg-gradient-to-br from-[#e7b6ad] via-[#c77261] to-[#D2897A] h-[20%] lgss:mt-6 rounded-[32px] lgss:flex lgss:items-center px-6">
