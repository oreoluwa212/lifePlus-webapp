...
const DetailsProviderCard = () => {
  return (
    <div className="lgss:w-[60%] lg:w-[80%] hidden bg-opacity-90 bg-[#dda195] bg-gradient-to-br from-[#e7b6ad] via-[#c77261] to-[#D2897A] lgss:h-[100px] py-3 lgss:mt-6 rounded-[32px] lgss:flex lgss:items-center px-6">
