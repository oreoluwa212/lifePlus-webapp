...
const LearningCard = ({ title, description, icon }) => {
  return (
    <div className="max-w-md mx-auto cursor-pointer border-none border-[1px] h-[250px] mds:w-[500px] w-[350px] rounded-[32px] overflow-hidden shadow-md flex justify-start items-end pb-6 bg-cover text-center" style={{ backgroundImage: `url(${learning})`}}>
