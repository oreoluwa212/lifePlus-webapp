    ...
    <div className="">
      ...
      <div className="mds:absolute mds:flex mds:flex-row h-[80vh] border-t-2 border-red bg-[#fafafa] w-full">
        <div className="mds:w-full absolute mds:relative top-0 mds:h-full overflow-auto mds:flex mds:flex-col mds:justify-center mds:items-center">
          <div className=" lgss:flex xs:flex flex-col shadow-lg shadow-gray-400/30 bg-white lgss:w-[50%] lgss:h-[65%] rounded-[32px] mds:justify-center mds:items-center mds:gap-9 xs:gap-8">
            ...
            <div className="mds:w-[90%] lgss:w-[60%] w-[100%] justify-between mds:flex mds:flex-col mds:gap-6">
              <input
                type="text"
              ...
              <Link to={"/new-password"}>
                <button className="h-[48px] mt-6 mds:mt-0 w-[100%] mds:w-[100%] flex justify-center items-center bg-red text-white rounded-[32px] text-[1.2rem]">
                  Submit Email
                </button>
              </Link>
            </div>
