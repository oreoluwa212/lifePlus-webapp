      ...
      <div className="lgss:w-4/5 w-full lgss:overflow-auto">
        <div className="lgss:w-full lgss:h-full lgss:flex-1 lgss:overflow lgss:px-[4%] flex flex-col ">
          ...
          <div className="flex flex-col gap-9 mt-4 lgss:mt-4 px-[5%] mds:px-0">
            <button className="bg-[#F3E4E4] w-[20%] lg:w-[25%] h-[50px] border-red border-[2px] rounded-[16px] text-red font-semibold text-[24px] shadow-lg shadow-red/30 flex justify-between items-center px-4"><span><PiPlusBold/> </span> Make a Post</button>
