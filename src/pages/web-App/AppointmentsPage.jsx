...
import { PiCalendarCheckFill, PiLadderSimpleFill, PiMapPinFill, PiUsersFill } from 'react-icons/pi';
          ...
          <div className="">
            <div className="flex flex-col justify-center items-start lgss:pt-8 pt-4">
              <div className=" flex flex-col lgss:grid lgss:grid-cols-3 gap-8">
                <DashboardCard title="Schedule New Appointments" icon={<PiUsersFill />} />
