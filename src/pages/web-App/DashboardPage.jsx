...
const DashboardPage = () => {
  return (
    <div className="flex flex-row h-screen">
      <SideBar />
      <div className="lgss:w-4/5 lgss:h-full lgss:overflow lgss:px-[4%] flex flex-col justify-between relative">
        <Header />
        ...
        <div className="">
          <div className="flex flex-col justify-center items-center lgss:pt-8 pt-4">
            <div className=" flex flex-col lgss:grid lgss:grid-cols-3 gap-8">
              ...
              />
              <DashboardCard title="News & Updates" icon={<PiArticleFill />} />
              <DashboardCard
                title="Points & Badges"
