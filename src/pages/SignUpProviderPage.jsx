  ...
  return (
    <div className="">
      ...
      <div className="relative mds:absolute mds:flex mds:flex-row mds:h-screen border-t-2 border-red w-full">
        <Demo />
        <div className="mds:w-3/5 w-full absolute mds:relative top-0 mt-[0%] mds:mt-5 mds:h-full overflow-hidden flex flex-col justify-end mds:justify-center pb-[40px] items-center h-[70vh]">
